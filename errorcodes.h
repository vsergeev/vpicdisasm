 ...
 *
 * errorcodes.h - All error codes that can take place during disassembler operation.
 *
 */
...
/* Enumerations for PIC Disassembler Error Codes,
...
enum PIC_Disassembler_Error_Codes {
